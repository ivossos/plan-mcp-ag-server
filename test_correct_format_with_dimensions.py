"""Test the correct format with 'dimensions' field in rows and columns."""
...
async def test_correct_format():
    ...
    # Based on Oracle documentation: rows and columns need "dimensions" field (plural)!
    grid_definition = {
    ...
    print("Testing format with 'dimensions' field:")
